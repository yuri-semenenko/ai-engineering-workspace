...
if (Test-Path $SkillsDir) {
  ...
  switch ($Seniority) {
    ...
    'staff'     { $rec += @('rfc', 'adr', 'module-design', 'complexity-audit', 'debt-ledger', 'security-pass', 'research', 'migration-plan') }
    'principal' { $rec += @('rfc', 'adr', 'module-design', 'complexity-audit', 'debt-ledger', 'research', 'migration-plan') }
  }
  ...
  switch ($Workflow) {
    ...
    'architecture-focused' { $rec += @('rfc', 'adr', 'module-design', 'complexity-audit', 'research', 'migration-plan') }
  ...
  $emphasis = switch ($Workflow) {
    ...
    'architecture-focused' { 'design-first skills: evidence-backed option research, RFCs, ADRs, module design, migration planning, and whole-tree complexity checks.' }
