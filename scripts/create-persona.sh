...
write_recommended_skills() {
  ...
  case "$SENIORITY" in
    ...
    staff)     rec="$rec rfc adr module-design complexity-audit debt-ledger security-pass research" ;;
    principal) rec="$rec rfc adr module-design complexity-audit debt-ledger research" ;;
  esac
  ...
  case "$WORKFLOW" in
    ...
    architecture-focused) rec="$rec rfc adr module-design complexity-audit research"
                          emphasis="design-first skills: evidence-backed option research, RFCs, ADRs, module design, and whole-tree complexity checks." ;;
