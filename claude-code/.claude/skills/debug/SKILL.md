...
- **Tag temporary instrumentation** so it is greppable and removable — a unique marker like `[dbg-a4f2]` on every debug log. Strip all of it in phase 7; shipped debug logging is a new bug.
