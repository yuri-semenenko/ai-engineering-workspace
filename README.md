...
so the usual result is three divergent piles of per-tool prompts that drift apart
the moment you edit one. That is a dotfiles problem dressed up as engineering.
...
canon, producing your `persona/persona.md` (full) and `persona/CLAUDE.md`
(condensed). See [`persona/README.md`](persona/README.md).
